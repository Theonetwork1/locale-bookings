...
export const ProfileScreen: React.FC<{ navigate: (s: Screen) => void }> = ({ navigate }) => {
  ...
  // Gère les changements de texte pour tous les champs
      ...
      <div className="px-6 -mt-12">
        <div className="bg-white rounded-3xl p-6 shadow-sm">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input 
                  name="firstName"
                  disabled={!isEditing} 
                  className={`w-full p-2 border-b ${isEditing ? 'border-orange-500' : 'border-gray-100'}`} 
            ...
            <div className="flex gap-2">
               <div className="w-24">
                  ...
                  <select 
                    name="countryCode"
                    disabled={!isEditing} 
                    className="w-full p-2 border-b border-gray-100 bg-transparent"
               ...
               <div className="flex-1">
                  ...
                  <input 
                    name="phone"
                    disabled={!isEditing} 
                    className="w-full p-2 border-b border-gray-100" 
                    value={user.phone}
                    onChange={handleChange}
                  />
               </div>
          ...
          <button 
            ...
            className="w-full mt-8 py-3 bg-orange-500 text-white rounded-xl font-bold hover:bg-orange-600 transition-colors"
          >
