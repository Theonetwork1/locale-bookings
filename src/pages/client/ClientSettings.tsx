        ...
        <Card className="lg:col-span-2">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-[#1A1A1A]">
              <User className="h-5 w-5 text-[#4B2AAD]" />
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor="fullName" className="text-[#1A1A1A]">{t.fullName}</Label>
                <Input
                  id="fullName"
              ...
              <div className="space-y-2">
                <Label htmlFor="email" className="text-[#1A1A1A]">{t.email}</Label>
                <Input
                  id="email"
                  type="email"
            ...
            <div className="space-y-2">
              <Label htmlFor="phone" className="text-[#1A1A1A]">{t.phone}</Label>
              <Input
                id="phone"
