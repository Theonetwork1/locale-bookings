      ...
      const mockNotifications: Notification[] = [
        {
          ...
          message: 'Tech Solutions Inc has registered on the platform',
          type: 'info',
        ...
        },
        {
          ...
          message: 'Monthly subscription payment received from Glo Salon',
          type: 'success',
      ...
      <header className="bg-white shadow-sm border-b px-6 py-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">System and platform notifications</p>
          </div>
          {unreadCount > 0 && (
