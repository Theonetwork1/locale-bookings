...
import { Building2, Save, Upload, MapPin, Navigation, Camera, ArrowLeft, Phone } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <h1 className="text-3xl font-bold text-foreground">{t.businessProfile || 'Business Profile'}</h1>
