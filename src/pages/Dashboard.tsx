...
const Dashboard = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="hover:shadow-md transition-shadow">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <Building2 className="h-4 w-4 text-[#4B2AAD]" />
          </CardHeader>
          <CardContent>
      ...
      {/* Management Modules */}
      <div>
        <h2 className="text-xl font-semibold text-[#1A1A1A] mb-4">Management Modules</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <Card 
          ...
          >
            <CardContent className="p-6 text-center">
              <div className="w-12 h-12 bg-[#4B2AAD]/10 rounded-lg flex items-center justify-center mx-auto mb-3">
                <Users className="w-6 h-6 text-[#4B2AAD]" />
              </div>
              <h3 className="font-semibold text-[#1A1A1A] mb-1">Team Management</h3>
              <p className="text-sm text-[#64748B]">Manage team members, roles & permissions</p>
            </CardContent>
          </Card>
          ...
          >
            <CardContent className="p-6 text-center">
              ...
              <h3 className="font-semibold text-[#1A1A1A] mb-1">Business Management</h3>
              <p className="text-sm text-[#64748B]">Manage business accounts & approvals</p>
            </CardContent>
          </Card>
          ...
          >
            <CardContent className="p-6 text-center">
              ...
              <h3 className="font-semibold text-[#1A1A1A] mb-1">Analytics & Reports</h3>
          ...
          >
            <CardContent className="p-6 text-center">
              ...
              <h3 className="font-semibold text-[#1A1A1A] mb-1">System Settings</h3>
